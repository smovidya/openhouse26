...
DROP TABLE `redeem_rewards`;--> statement-breakpoint
PRAGMA foreign_keys=OFF;--> statement-breakpoint
CREATE TABLE `__new_checkins` (
	`id` text PRIMARY KEY NOT NULL,
	`participant_ticket_code` text,
...
INSERT INTO `__new_checkins`("id", "participant_ticket_code", "checked_by_staff_id", "checkpoint_id", "data", "created_at", "updated_at", "deleted_at") SELECT "id", "participant_ticket_code", "checked_by_staff_id", "checkpoint_id", "data", "created_at", "updated_at", "deleted_at" FROM `checkins`;--> statement-breakpoint
