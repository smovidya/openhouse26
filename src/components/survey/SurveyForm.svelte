<script lang="ts">
  ...
  const firstImpressionOptions = [
    ...
    { label: "พี่ ๆ หล่อ ๆ สวย ๆ จึ้ง", value: "พี่ๆหล่อๆสวยๆจึ้ง" },
  ...
  const staffAnswerOptions = [
    ...
    { label: "แทบไม่ได้คุยกับพี่ ๆ เลย", value: "แทบไม่ได้คุยกับพี่ๆเลย" },
  ];
...
<div class="text-left w-full">
  ...
  />
  <TextInput
    label="น้อง ๆ คิดว่าบริเวณไหนของงานที่รู้สึกว่าค่อนข้างแออัด เช่น เวิร์คชอป บูธ อื่น ๆ (ไม่บังคับ)"
  ...
  <RadioGroup
    label="ความรู้สึกแรกที่เดินเข้ามาในงาน น้อง ๆ รู้สึกเป็นอย่างไรบ้าง"
  ...
  <RadioGroup
    label="เมื่อน้องถามสต๊าฟแล้ว ได้คำตอบที่สามารถตอบข้อสงสัยของน้อง ๆ ได้มั้ย"
  ...
  <TextInput
    label="มีอะไรอยากบอกทีมจัดงานไหม รวม ๆ หรือพี่คนไหนก็ได้ เดี๋ยวไปบอกต่อให้ (ไม่บังคับ)"
